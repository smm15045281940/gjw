...
public class ContractCompanyGridAdapter extends BaseAdapter {
    ...
    public ContractCompanyGridAdapter(Context context, List<ContractCompany> list) {
    ...
    class ViewHolder {
        ...
        public ViewHolder(View itemView) {
            ...
            tv1 = (TextView) itemView.findViewById(R.id.tv_item_contractcompany_grid_companyName);
            tv2 = (TextView) itemView.findViewById(R.id.tv_item_contractcompany_grid_companyDuty);
            tv3 = (TextView) itemView.findViewById(R.id.tv_item_contractcompany_grid_companyAddress);
        }
    }
}
