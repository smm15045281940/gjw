...
public class MineVoucherFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        rootView = inflater.inflate(R.layout.fragment_voucher_mine, null);
        initView();
        initData();
        loadData();
        return rootView;
    ...
    private void initRoot() {
        ...
        lv = (ListView) rootView.findViewById(R.id.lv_voucher_mine);
    }
    ...
    private void initEmpty() {
        ...
        ((ImageView) emptyView.findViewById(R.id.iv_empty_icon)).setImageResource(ParaConfig.VOUCHER_ICON);
        ((TextView) emptyView.findViewById(R.id.tv_empty_hint)).setText(ParaConfig.VOUCHER_HINT);
        ((TextView) emptyView.findViewById(R.id.tv_empty_content)).setText(ParaConfig.VOUCHER_CONTENT);
